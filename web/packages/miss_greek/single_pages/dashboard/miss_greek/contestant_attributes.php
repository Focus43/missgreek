...
<? } else if ($this->controller->getTask() == 'select_type' || $this->controller->getTask() == 'add' || $this->controller->getTask() == 'edit') { ?>
    ...
    <?=Loader::helper('concrete/dashboard')->getDashboardPaneHeaderWrapper(t('Contestant Attributes'), false, false, false)?>
...
<? } else { ?>
    ...
    Loader::element('dashboard/attributes_table', array('category' => $category, 'attribs'=> $attribs, 'editURL' => '/dashboard/miss_greek/contestant_attributes')); ?>
